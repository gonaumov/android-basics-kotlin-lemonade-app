...
class MainActivity : AppCompatActivity() {
    ...
    private fun clickLemonImage() {
        when (lemonadeState) {
            ...
            SQUEEZE -> {
                squeezeCount = squeezeCount.inc()
                lemonSize = lemonSize.dec()
                if (lemonSize == 0) {
                    lemonadeState = DRINK
                }
            }
    ...
    private fun setViewElements() {
        ...
        when (lemonadeState) {
            ...
            RESTART -> {
                ...
                val resourceName = "lemon_${lemonadeState}"
                textAction.setText(resources.getIdentifier(resourceName, "string", packageName))
